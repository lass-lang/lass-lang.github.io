...
import lassGrammar from '../../../plugins/vscode-lass-languageservice/syntaxes/lass.tmLanguage.json' with { type: 'json' }
...
export async function mdPages(options: MdPagesOptions): Promise<Plugin> {
  const shikiPlugin = await Shiki({
    ...
    // Grammar location: plugins/vscode-lass-languageservice/syntaxes/lass.tmLanguage.json
